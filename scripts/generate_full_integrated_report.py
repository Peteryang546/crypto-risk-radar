...
# Import data fetcher (PowerShell bridge to bypass SSL issues)
try:
    from data_fetcher_ps import get_data
    DATA_SOURCES_AVAILABLE = True
    print("[INFO] Using PowerShell data fetcher (bypasses Python SSL issues)")
except ImportError:
    print("[WARNING] data_fetcher_ps not available, using demo data")
